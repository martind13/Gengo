...
public class Chapter1_12 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_chapter1_12);
    ...
    public void onBackPressed() {
        startActivity(new Intent(Chapter1_12.this, Chapter1_11.class));
    }

    public void goHome(View view){
        startActivity(new Intent(Chapter1_12.this, WelcomeScreen.class));
    }
}
