...
public class Chapter1_15 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_chapter1_15);
    ...
    public void onBackPressed() {
        startActivity(new Intent(Chapter1_15.this, Chapter1_14.class));
    }
}
