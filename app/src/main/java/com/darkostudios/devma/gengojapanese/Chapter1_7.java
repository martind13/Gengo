...
public class Chapter1_7 extends TransitionActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_chapter1_7);
    ...
    public void goToGame(View view){
        Intent myIntent = new Intent(Chapter1_7.this, RomanjiGame.class);
        Chapter1_7.this.startActivity(myIntent);
        finish();
    }
    public void goBack(View view){
        Intent myIntent = new Intent(Chapter1_7.this, Chapter1_5.class);
        Chapter1_7.this.startActivity(myIntent);
        finish();
    }
