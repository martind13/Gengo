...
public class Chapters extends TransitionActivity {
    ...
    public void chapter1Click(View view) {
        Intent myIntent = new Intent(Chapters.this, Chapter1_Welcome.class);
        Chapters.this.startActivity(myIntent);
        finish();
    }
    @Override
    public void onBackPressed() {
        startActivity(new Intent(Chapters.this, WelcomeScreen.class));
    }
