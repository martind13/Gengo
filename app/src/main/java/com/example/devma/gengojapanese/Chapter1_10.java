...
public class Chapter1_10 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_chapter1_10);
    ...
    public void onBackPressed() {
        startActivity(new Intent(Chapter1_10.this, Chapter1_9.class));
    }
}
